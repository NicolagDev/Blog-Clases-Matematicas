---
title: Relación de Fuerza, Masa y Aceleración.
topic: Física
date: 2026-09-09
description: Explicar y entender la relación entre Fuerza al momento de
  calcularse con la masa y la aceleración aplicada a un objeto o cuerpo, y como
  a partir de datos como la Fuerza y la Masa podemos lograr sacar la aceleración
  y viceversa.
...
$ F / M = A \implies \frac{100\text{ N}}{10\text{ kg}} = A$
